...
function Footer() {
  ...
  return (
    <div className='w-full absolute px-6 lg:px-0 md:px-6 text-black/75 dark:text-white/65 py-10 text-sm pb-3 bg-white dark:bg-black flex justify-center items-center '>
