...
const contentInitial = { opacity: 0, height: 0 } as const;
...
const getContentAnimate = (expanded: boolean) => ({
...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  // Height now tracks the actual rendered height of the timeline container
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-10">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-cyan-500 via-cyan-700 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
