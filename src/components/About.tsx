...
function About() {
  return (
    <motion.section 
      className=' mb-28 max-w-[45rem] scroll-mt-48 text-center leading-8'
    ...
    >
        ...
        <p className='mb-3 text-black/90 dark:text-white/65'>
        ...
        <p className='text-black/90 dark:text-white/65'>
