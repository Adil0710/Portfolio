...
const ThemeSwitch = () => {
  ...
  return (
    ...
    >
      <span>
        {theme === "light" ? (
          <SunIcon className="h-[1.1rem] w-[1.1rem] rotate-0 scale-100 dark:-rotate-90 dark:scale-0" />
        ) : (
          <MoonIcon className="h-[1.1rem] w-[1.1rem] rotate-90 scale-0 dark:rotate-0 dark:scale-100" />
        )}
      </span>
